...
export const products: Product[] = [
  // ─── KIDS · IN-STOCK (pré-personalizados — sem opção de customizar) ──
  {
    ...
    name: { pt: 'FC Barcelona Lamine Yamal #10 Kids 2024/25', en: 'FC Barcelona Lamine Yamal #10 Kids 2024/25' },
    team: 'FC Barcelona',
    season: '2024/25',
    kitType: 'home',
    version: 'adepto',
  ...
  },
  {
    ...
    name: { pt: 'Portugal Ronaldo #7 Principal Kids 2024/25', en: 'Portugal Ronaldo #7 Home Kids 2024/25' },
  ...
  },
  {
    ...
    name: { pt: 'Portugal Ronaldo #7 Alternativa Kids 2024/25', en: 'Portugal Ronaldo #7 Away Kids 2024/25' },
    team: 'Seleção Nacional',
    season: '2024/25',
    kitType: 'away',
    version: 'adepto',
  ...
  // ─── KIDS · PRE-ORDER (com personalização customizável a +3€) ────────
  {
    ...
    name: { pt: 'Sporting CP Principal Kids 2024/25', en: 'Sporting CP Home Kids 2024/25' },
    team: 'Sporting CP',
    season: '2024/25',
    kitType: 'home',
    version: 'adepto',
  ...
  },
  {
    ...
    name: { pt: 'FC Porto Principal Kids 2024/25', en: 'FC Porto Home Kids 2024/25' },
    team: 'FC Porto',
    season: '2024/25',
    kitType: 'home',
    version: 'adepto',
  ...
  },
  {
    ...
    name: { pt: 'SL Benfica Principal Kids 2024/25', en: 'SL Benfica Home Kids 2024/25' },
    team: 'SL Benfica',
    season: '2024/25',
    kitType: 'home',
    version: 'adepto',
