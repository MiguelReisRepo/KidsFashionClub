...
export const products: Product[] = [
  ...
  // ─── ADULTS · PRE-ORDER ──────────────────────────────────────────────
  {
    ...
    shippingDays: 18,
    images: ['/products/placeholder-preorder.svg', '/products/placeholder-preorder-back.svg'],
    description: {
  ...
  // ─── KIDS · IN-STOCK (genérico, customizável) ────────────────────────
  {
    id: '101',
  ...
  // ─── KIDS · PRE-ORDER ────────────────────────────────────────────────
  {
    ...
    availability: 'pre_order',
    shippingDays: 18,
    images: ['/products/placeholder-kids-preorder.svg', '/products/placeholder-kids-preorder-back.svg'],
    description: {
